    ...
    return ( 
        <div className="flex flex-col justify-center divide-y divide-slate-200">
            <div className="w-full max-w-2xl mx-auto md:pb-40 md:pt-0">
                <div className="my-6 md:overflow-y-scroll md:h-[300px] scrollbar-hide">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center
                                 justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0
                                  text-emerald-600 bg-emerald-100 rounded-full ">{data.date}</time>

                                  <p className="text-xl font-bold text-gray-400">
                                    {data.subtitle}
                                  </p> 
                            </div>
                             <p className="text-slate-400 lg:mr-25 max-w-md">
                                    {data.description}
                                  </p>
                        </div>
                    ))}
